...
exports.CloudDelInputSchema = exports.FileDelInputSchema = exports.FileUpdateInputSchema = exports.FileInputSchema = void 0;
...
exports.CloudDelInputSchema = joi_1.default.object({
    oldImgURL: joi_1.default.string().min(90).required()
});
